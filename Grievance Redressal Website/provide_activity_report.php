...
<div class="row">
    ...
    <div class="row">
        <div class="col-md-12">
            <form class="bootstrap-form-with-validation" action="provide_activity_report.php" method="post">
                ...
                <div class="form-group">
                    <!--<label class="control-label" for="textarea-input">Enter Complain</label>-->
                    <textarea class="form-control input-lg" rows="5" wrap="hard" name="activity_report" placeholder="Enter Activity Report" id="textarea-input" required></textarea>
                </div>
                <div class="form-group">
...
<?php
    ...
    if(isset($_POST['submit'])) {
    	...
    	$activity_report = $_POST['activity_report'];
    	$d = new database();
		...
		$_SESSION['message'] = "Activity Report Provided";
		$_SESSION['link'] = "municipal_homepage.php";
		header("Location: error.php");
        exit;
	}
