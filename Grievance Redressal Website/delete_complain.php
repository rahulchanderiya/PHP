...
<div class="row">
    ...
    <div class="row">
        <div class="col-md-12">
            <form class="bootstrap-form-with-validation" action="delete_complain.php" method="post">
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control input-lg" rows="2" wrap="hard" name="complain_no" placeholder="Complain No." id="textarea-input" required></textarea>
                </div>
                <div class="form-group">
                    <button class="btn btn-success btn-lg" type="submit" name="submit">Delete</button>
                </div>
            </form>
        </div>
    </div>
...
<?php
    ...
    if(isset($_POST['submit'])) {
		...
		$_SESSION['message'] = "Complain Deleted Successfully";
		$_SESSION['link'] = "admin_homepage.php";
		header("Location: error.php");
        exit;
	}
