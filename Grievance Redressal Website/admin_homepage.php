	...
	<div class="row">
		<div id="sidebar-left" class="col-xs-2 col-sm-2">
			<ul class="nav main-menu">
				<li>
					<a href="admin_dashboard.php" class="ajax-link">
				...
				<li class="dropdown">
					...
					<ul class="dropdown-menu">
						...
						<li><a class="ajax-link" href="invalid_complain_table.php">Invalid Complains</a></li>
						<li><a class="ajax-link" href="delete_complain.php">Delete Complain</a></li>
					</ul>
				</li>
				<li class="dropdown">
					<a href="#" class="dropdown-toggle">
				...
				<li class="dropdown">
					...
					<ul class="dropdown-menu">
						<li><a class="ajax-link" href="mailer.php">Mail to Employee</a></li>
					</ul>
				</li>
				<!-- <li class="dropdown">
					<a href="#" class="dropdown-toggle">
