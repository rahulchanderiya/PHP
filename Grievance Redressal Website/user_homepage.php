...
$d = new database();
$user_name = $d->user->get_user_name($user_id);
	...
	<div class="row">
		<div id="sidebar-left" class="col-xs-2 col-sm-2">
			<ul class="nav main-menu">
				<li>
					<a href="user_dashboard.php" class="ajax-link">
				...
				<li class="dropdown">
					...
					<ul class="dropdown-menu">
						<li><a class="ajax-link" href="user_complain_table.php">My Complains</a></li>
						<li><a class="ajax-link" href="all_complain_table.php">All Complains</a></li>
						<li><a class="ajax-link" href="file_new_complain.php">File New Complain</a></li>
					</ul>
				</li>
				<li class="dropdown">
					<a href="#" class="dropdown-toggle">
					...
					<ul class="dropdown-menu">
						<li><a class="ajax-link" href="give_suggestion.php">Give Suggestion</a></li>
					</ul>
				</li>
				<li class="dropdown">
					<a href="#" class="dropdown-toggle">
					...
					<ul class="dropdown-menu">
						<li><a class="ajax-link" href="give_feedback.php">Give FeedBack</a></li>
					</ul>
				</li>
				<li class="dropdown">
					<a href="#" class="dropdown-toggle">
					...
					<ul class="dropdown-menu">
						<li><a class="ajax-link" href="my_ngo_table.php">My NGO</a></li>
						<li><a class="ajax-link" href="all_ngo_table.php">All NGO</a></li>
						<li><a class="ajax-link" href="join_new_ngo.php">Join New NGO</a></li>
						<li><a class="ajax-link" href="form_new_ngo.php">Form New NGO</a></li>
					</ul>
				</li>
			</ul>
		</div>
